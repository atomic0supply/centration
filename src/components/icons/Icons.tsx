...
const icon = (paths: ReactElement, size = 22) =>
  function Icon({ size: s = size, className = '' }: IconProps) {
    return (
      <svg
        width={s}
        height={s}
...
export const IconConcierge = icon(
  <>
...
export const IconGoogle = ({ size = 20 }: IconProps) => (
